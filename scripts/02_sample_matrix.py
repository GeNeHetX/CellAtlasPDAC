...
RNA_matrix_path = Path("/cellstatesappli/RNAmatrix.tsv")
...
for sample_id in sample_ids:
    columns_to_keep = RNA_matrix.columns[RNA_matrix.columns.str.contains(f'{sample_id}_')]
    ...
    filtered_path = Path(f"/cellstatesappli/RNAmatrix_{sample_id}.tsv")
