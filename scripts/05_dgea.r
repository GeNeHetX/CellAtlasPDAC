...
expression_mtx_path <- '/home/celia/Documents/VisualStudioCode/ZHANG/zhang/Zhang.rawcount.V1.mtx'
features_path <- '/home/celia/Documents/VisualStudioCode/ZHANG/zhang/Zhang.geneAnnotation.V1.tsv'
subset_base_path <- '/home/celia/Documents/VisualStudioCode/ZHANG/cellstatesappli'
output_path <- "/home/celia/Documents/annotation/findmarkers/zhang"

# Define subsets to process
subsets <- c('Case1.YF', 'Case1.ZY', 'Case2.YF', 'Case2.ZC', 'Case2.ZY', 'Case3.YF', 'Case3.ZY', 'Case4.ZY')
